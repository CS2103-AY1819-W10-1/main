...
public class CommandTestUtil {
    ...
    public static final String PHONE_DESC_AMY = " " + PREFIX_COMMENT + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_COMMENT + VALID_PHONE_BOB;
    public static final String EMAIL_DESC_AMY = " " + PREFIX_LINK + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_LINK + VALID_EMAIL_BOB;
    ...
    public static final String INVALID_PHONE_DESC = " " + PREFIX_COMMENT + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_LINK + "bob!yahoo"; // missing '@' symbol
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        final String[] splitName = entry.getTitle().fullName.split("\\s+");
