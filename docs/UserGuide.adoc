...
=== Add reader links: `readeradd` `[coming in v2.0]`

Adds a hyperlink displayed in the reader.

Format: `readeradd INDEX`

Examples:

- `readerlist` Lists all the hyperlinks in the reader. +
`readeradd 3` Adds the 3rd hyperlink shown in the reader.
